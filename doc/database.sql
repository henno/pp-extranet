...
VALUES ('projectVersion', '0'),
       ('translationUpdateLastRun', '2021-02-22 00:00:00');
/*!40000 ALTER TABLE `settings`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `translationLanguages`
    DISABLE KEYS */;
INSERT INTO `translationLanguages`
VALUES ('af', 'Afrikaans'),
       ('am', 'Amharic'),
       ('ar', 'Arabic'),
       ('az', 'Azerbaijani'),
...
/*!40000 ALTER TABLE `users`
    DISABLE KEYS */;
INSERT INTO `users`
VALUES (1, 'Demo User', 'demo@example.com', 1, '$2y$10$vTje.ndUFKHyuotY99iYkO.2aHJUgOsy2x0RMXP1UmrTe6CQsKbtm', 0);
/*!40000 ALTER TABLE `users`
    ENABLE KEYS */;
UNLOCK TABLES;
