    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item <?= $action == 'users' ? 'active' : '' ?>">
                <a class="nav-link"
                   href="admin/users"><?= __('Users') ?> <?= $action == 'users' ? '<span class="visually-hidden">(current)</span>' : '' ?></a>
            </li>
            <li class="nav-item <?= $action == 'logs' ? 'active' : '' ?>">
                <a class="nav-link"
                   href="admin/logs"><?= __('Logs') ?> <?= $action == 'logs' ? '<span class="visually-hidden">(current)</span>' : '' ?></a>
            </li>
            <li class="nav-item <?= $controller == 'halo' ? 'active' : '' ?>">
                <a class="nav-link"
                   href="halo"><?= __('Halo') ?> <?= $action == 'halo' ? '<span class="visually-hidden">(current)</span>' : '' ?></a>
            </li>
            <li class="nav-item <?= $action == 'translations' ? 'active' : '' ?>">
                <a class="nav-link"
                   href="admin/translations"><?= __('Translations') ?> <?= $action == 'translations' ? '<span class="visually-hidden">(current)</span>' : '' ?></a>
            </li>
        </ul>
